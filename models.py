...
class PayPeriod(db.Model):
    ...
    status = db.Column(db.String(20), default='Open')  # Open, Closed, Processing, Completed
...
class Payroll(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    employee_id = db.Column(db.Integer, db.ForeignKey('employees.id'), nullable=False)
    pay_period_id = db.Column('payroll_period_id', db.Integer, db.ForeignKey('pay_periods.id'), nullable=False)
